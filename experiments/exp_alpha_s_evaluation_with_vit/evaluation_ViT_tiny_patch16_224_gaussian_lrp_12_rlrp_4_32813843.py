...
val_metrics = evaluate(
    ...
    make_alpha_fig=True, alpha_fig_path=os.path.join(cfg.output_dir, "val/hists/alpha_hist_per_true_bin"), alpha_class_names=("0.2","0.3","0.4"),
    make_alpha_avgprob_fig=True,   alpha_avgprob_fig_path= os.path.join(cfg.output_dir, "val/hists/alpha_avgprob_per_true_bin")
)
